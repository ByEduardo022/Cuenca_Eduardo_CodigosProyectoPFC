...
<body class="min-h-screen bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center">
    <a href="index.php"
        ...
        <div class="bg-white rounded-xl shadow-2xl overflow-hidden">
            <div class="md:flex">
                ...
                <div class="md:w-1/2 p-8">
                    <h5 class="text-center font-bold text-red-800 mb-4">El Email introducido ya pertenece a una cuenta. Prueba a iniciar sesión.</h5>
